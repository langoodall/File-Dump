...
# writeRaster(ecoregions,
#             filename = "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/Three_Counties_Rasters/Ecoregions1.tif",
#             datatype = "INT1U",
#             NAflag = NA,
#             overwrite = TRUE)
```
...
```{r}
ecoregionsTest <- rast("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/Ecoregions1.tif")
values(ecoregionsTest) <- 0
ecoregionsTest[480:679,450:499] <- 1

plot(ecoregionsTest)
plot(ManagementAreaRast)

# writeRaster(ecoregionsTest,
#             filename = "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL Experiment/Rasters/ecoregionsTest.tif",
#             datatype = "INT1U",
#             NAflag = NA,
#             overwrite = TRUE)
```
