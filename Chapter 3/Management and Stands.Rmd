...
ICMap <- rast("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL_Experiment/Rasters/TCTreeMap.tif")
mapCodeDf <- read_csv("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL_Experiment/MapCodeDf.csv")
...
writeRaster(allMARast,
            filename = "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL_Experiment/Harvest/ManagementAreas4.tif",
            datatype = "INT1U",
            NAflag = 0,
            overwrite = TRUE)
...
standsTC <- st_read("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL_Experiment/Shapefiles/standsTC.shp") %>%
  st_transform(., crs = "EPSG:26917") %>%
...
writeRaster(standRast,
            filename = "C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 3/SOSIEL_Experiment/Harvest/standRast.tif",
            NAflag = 0,
            datatype = "INT4S",
            overwrite = TRUE)
