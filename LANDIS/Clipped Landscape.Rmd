...
wiltPDf <- values(projectedRasters[[22]]) %>% as.data.frame() %>% drop_na()
fieldCDf <- values(projectedRasters[[7]]) %>% as.data.frame() %>% drop_na()
...
# Check to see if all filed capacity values are above wiltpoint
# They are but when I run the simulation it isn't having it
plot(projectedRasters[[22]] > projectedRasters[[7]])



wiltPoint <- rast("C:/Users/lagoodal/Desktop/All Raster Layers/Clipped Piedmont/Wiltpoint.tif")
fieldCapacity <- rast("C:/Users/lagoodal/Desktop/All Raster Layers/Clipped Piedmont/FieldCapacity.tif")

plot(wiltPoint)
plot(fieldCapacity)

plot(wiltPoint > fieldCapacity)


#Wiltpoint <-  ifel(Wiltpoint > Field Capacity, FieldCapacity - 0.01, Wiltpoint)
...
plot(projectedRasters[[22]])

plot(projectedRasters[[7]])
...
hist(wiltPDf$Wiltpoint)

hist(fieldCDf$FieldCapacity)
...
plot(ecoregionsClipped)

fakeEcoregions <- ecoregionsClipped


fakeEcoregions[47,1114]

projectedRasters[[1]][47,1114]
projectedRasters[[2]][47,1114]
projectedRasters[[3]][47,1114]
projectedRasters[[4]][47,1114]
projectedRasters[[5]][47,1114]
projectedRasters[[6]][47,1114]
projectedRasters[[7]][47,1114]
projectedRasters[[8]][47,1114]
projectedRasters[[9]][47,1114]
projectedRasters[[10]][47,1114]
projectedRasters[[11]][47,1114]
projectedRasters[[12]][47,1114]
projectedRasters[[13]][47,1114]
projectedRasters[[14]][47,1114]
projectedRasters[[15]][47,1114]
projectedRasters[[16]][47,1114]
projectedRasters[[17]][47,1114]
projectedRasters[[18]][47,1114]
projectedRasters[[19]][47,1114]
projectedRasters[[20]][47,1114]
projectedRasters[[21]][47,1114]
projectedRasters[[22]][47,1114]




fieldCapacity <- projectedRasters[[7]]
wiltPoint <- projectedRasters[[22]]

values(fieldCapacity) <- 0.30
values(wiltPoint) <- 0.15


values(projectedRasters[[7]])


writeRaster(wiltPoint,
            filename = "C:/Users/lagoodal/Desktop/All Raster Layers/Clipped Piedmont/Wiltpoint.tif",
            datatype = "FLT4S",
            overwrite = TRUE)

writeRaster(fieldCapacity,
            filename = "C:/Users/lagoodal/Desktop/All Raster Layers/Clipped Piedmont/FieldCapacity.tif",
            datatype = "FLT4S",
            overwrite = TRUE)
```
...
testEcoregions <- ecoregionsClipped

#plot(testEcoregions)

values(testEcoregions) <- 0
testEcoregions[100,600] <- 1
testEcoregions[101,600] <- 2


writeRaster(testEcoregions,
            filename = "C:/Users/lagoodal/Desktop/All Raster Layers/testEcoregions.tif",
            datatype = "INT4S",
            overwrite = TRUE,
            NAflag = 0)
...
plot(projectedRasters[[12]])
x <- values(projectedRasters[[12]]) %>%
  as.data.frame() %>%
  drop_na()
...
testSoilDepth <- projectedRasters[[12]]

values(testSoilDepth) <- 100

writeRaster(testSoilDepth,
            filename = "C:/Users/lagoodal/Desktop/All Raster Layers/testSoilDepth.tif",
            datatype = "INT4S",
            overwrite = TRUE,
            NAflag = 0)


plot(testEcoregions, col = c("gray", "red", "blue"))
plot(projectedRasters[[10]])

plot(projectedRasters[[1]])

values(projectedRasters[[1]])
```
